  ...
  return (
    <div className="linktree-container">
      ...
      <LinkButton
        icon="spotify"
        text="spotify"
        class="linktree-button"
        sx={{ marginTop: "2rem" }}
        link="https://open.spotify.com/artist/4mkEgOb3c1imuAXwyeSHug?si=m56OVxS3RmiYkxbTXbws4A"
      />
      <LinkButton
        icon="apple"
        text="apple music"
        class="linktree-button"
        link="https://music.apple.com/us/artist/gain-online/1744697316"
      />
      <LinkButton
        icon="soundcloud"
        text="soundcloud"
        class="linktree-button"
        link="https://soundcloud.com/gain_online"
      />
    </div>
  );
}
