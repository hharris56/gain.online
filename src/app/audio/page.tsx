  ...
  return (
    <div className="page-content-container">
      <div style={{ marginBottom: "1rem" }}>
        <h1 className="text-4xl font-bold my-4">gain audio</h1>
      ...
      <div className="audio-selector-container" style={{ marginTop: "1rem" }}>
        <SelectorButton
          text={releases}
          onClick={() => setSelected(releases)}
          selected={selected == releases}
        />
        <SelectorButton
          text={albums}
      ...
      <div className={"release-container"}>
        ...
        <div className="release-info">
          <div className="release-text">
            ...
            <a
              style={{ color: "var(--secondary-text-color)", fontSize: "1rem" }}
            >
              {props.date}
            </a>
            <MusicLinkBar links={props.links} sx={{ margin: "2rem 0rem" }} />
