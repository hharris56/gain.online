        ...
        <>
            ...
            <div style={{width: "100%", display: "flex", justifyContent: "center", marginBottom: "2rem"}}>
                <div style={{maxWidth: "50rem"}}>
                    ...
                    <p>inspired by the bleak landscapes and brutalist architecture of central and eastern europe, 'overseas' explores the spiritual and emotional burdens that arise from the pursuit of pleasure, and recount the events of an unknown protaganist during a single night overseas.</p>
                    <p>the desolate soundscapes and droning pads are punctuated by lush arpeggios and driving basslines to create a wave of sound and emotion that rush past, leaving only traces of some featureless longing in their wake.</p>
            ...
            <div style={{width: "100%", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", marginBottom: "2rem"}}>
                <h2 style={{width: "100%", textAlign: "center"}}>influences + inspiration</h2>
                ...
                >
                    <iframe src="https://www.youtube.com/embed/N9oY7I720vw?si=SvBxsBgBczvjz22Z" style={{width: "20rem", marginRight: !isMobile ? "2rem" : "0rem"}}/>
                </Influence>
                <Influence
                    title="k2 calling"
                    author="mike horn"
                ...
                >
                    <iframe src="https://www.youtube.com/embed/mYV0moSe8Co?si=xonNOJZmAwRsCycf" style={{width: "20rem", marginRight: !isMobile ? "2rem" : "0rem"}}/>
                </Influence>
                <Influence
                    title="aleph"
                    author="paulo coelho"
...
const Influence = (props: PropsWithChildren<InfluenceProps>) => {
    ...
    return (
        <div style={{display: "flex", flexDirection: !isMobile ? "row" : "column", alignItems: "center", justifyContent: "center", marginBottom: "2rem", maxWidth: "50rem"}}>
            {props.children}
